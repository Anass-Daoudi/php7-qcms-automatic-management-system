...
function b() {
	...
	if (test) {
		...
		// Added by Anass from here
		hidden = document.createElement("input");
		hidden.setAttribute("type", "hidden");
		hidden.setAttribute("id", "hidden" + i);
		hidden.setAttribute("name", "hidden" + i);
		baliseDiv.appendChild(hidden);
		// to here
...
/*
 * function afficher(){ divG=document.createElement("div");
 * div1=document.createElement("div"); nombre=document.createTextNode("1-");
 * question=document.createElement("input");
 * question.setAttribute("type","text"); div1.appendChild(nombre);
 * div1.appendChild(question); divG.appendChild("div1");
...
function addResponse() {
	...
	// Added by Anass from here
	document.getElementById("hidden" + i).value = inputDiv2.value;
	// to here
